...
protected override void View()
{
	...
	{
	loop__id++;
	ViewBuilder.Append("<option value=\"" + echo(sites.sitepath) + "\" "+(sites.sitepath==mainsite?"selected":"")+">" + echo(sites.name) + "</option>\r\n");
	}//end loop
	...
	ViewBuilder.Append("                    <td>\r\n");
	ViewBuilder.Append("                        <input name=\"disableie\" type=\"checkbox\" value=\"ie6\" id=\"disableie6\" "+(FPUtils.IsContain("ie6",sysconfiginfo.disableie)?"checked":"")+">IE6&nbsp;\r\n");
	ViewBuilder.Append("                        <input name=\"disableie\" type=\"checkbox\" value=\"ie7\" id=\"disableie7\" "+(FPUtils.IsContain("ie7",sysconfiginfo.disableie)?"checked":"")+">IE7&nbsp;\r\n");
	ViewBuilder.Append("                        <input name=\"disableie\" type=\"checkbox\" value=\"ie8\" id=\"disableie8\" "+(FPUtils.IsContain("ie8",sysconfiginfo.disableie)?"checked":"")+">IE8&nbsp;\r\n");
	ViewBuilder.Append("                        <input name=\"disableie\" type=\"checkbox\" value=\"ie9\" id=\"disableie9\" "+(FPUtils.IsContain("ie9",sysconfiginfo.disableie)?"checked":"")+">IE9&nbsp;\r\n");
	ViewBuilder.Append("                        <input name=\"disableie\" type=\"checkbox\" value=\"ie10\" id=\"disableie10\" "+(FPUtils.IsContain("ie10",sysconfiginfo.disableie)?"checked":"")+">IE10&nbsp;\r\n");
	ViewBuilder.Append("                        <input name=\"disableie\" type=\"checkbox\" value=\"ie11\" id=\"disableie11\" "+(FPUtils.IsContain("ie11",sysconfiginfo.disableie)?"checked":"")+">IE11&nbsp;\r\n");
	ViewBuilder.Append("                        <input name=\"disableie\" type=\"checkbox\" value=\"ie12\" id=\"disableie12\" "+(FPUtils.IsContain("ie12",sysconfiginfo.disableie)?"checked":"")+">IE12&nbsp;&nbsp;如果选择不支持的IE版本，系统将提示浏览器下载页面。\r\n");
	ViewBuilder.Append("                    </td>\r\n");
	ViewBuilder.Append("                  </tr>\r\n");
	ViewBuilder.Append("                  <tr>\r\n");
	ViewBuilder.Append("                    <td class=\"td_class\"> 是否记录操作日志： </td>\r\n");
	ViewBuilder.Append("                    <td height=\"25\"><input id=\"allowlog1\" name=\"allowlog\" type=\"radio\" "+(sysconfiginfo.allowlog==1?"checked":"")+" value=\"1\">开&nbsp;<input id=\"allowlog0\" name=\"allowlog\" type=\"radio\" "+(sysconfiginfo.allowlog==0?"checked":"")+" value=\"0\">关&nbsp;&nbsp;为了提高系统的安全性，在站点稳定上线之后请开启。\r\n");
	ViewBuilder.Append("                    </td>\r\n");
	ViewBuilder.Append("                  </tr>\r\n");
	ViewBuilder.Append("                  <tr>\r\n");
	ViewBuilder.Append("                    <td class=\"td_class\"> 浏览自动编译模板： </td>\r\n");
	ViewBuilder.Append("                    <td height=\"25\"><input id=\"browsecreatesite1\" name=\"browsecreatesite\" type=\"radio\" "+(sysconfiginfo.browsecreatesite==1?"checked":"")+" value=\"1\">开&nbsp;<input id=\"browsecreatesite0\" name=\"browsecreatesite\" type=\"radio\" "+(sysconfiginfo.browsecreatesite==0?"checked":"")+" value=\"0\">关&nbsp;&nbsp;为了提高系统性能，在站点稳定上线之后请关闭。\r\n");
	ViewBuilder.Append("                    </td>\r\n");
	ViewBuilder.Append("                  </tr>\r\n");
	ViewBuilder.Append("                  <tr>\r\n");
