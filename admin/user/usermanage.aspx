...
protected override void View()
{
	...
	ViewBuilder.Append("              <li style=\"background: url(" + echo(webpath) + "" + echo(sitepath) + "/statics/images/add.gif) 2px 6px no-repeat\"><a href=\"useradd.aspx?s_roleid=" + echo(s_roleid) + "&s_departid=" + echo(s_departid) + "&s_depts=" + echo(s_depts) + "&s_gradeid=" + echo(s_gradeid) + "\">添加用户</a></li>\r\n");
	...
	ViewBuilder.Append("              <li style=\"display:"+(backurl!=""?"block":"none")+";background: url(" + echo(webpath) + "" + echo(sitepath) + "/statics/images/back.png) 2px 6px no-repeat\"><a href=\"" + echo(backurl) + "\">返回</a></li>\r\n");
	...
	ViewBuilder.Append("        	    <td width=\"60\">登录类型</td>\r\n");
	...
	ViewBuilder.Append("              <td align=\"center\" title=\"" + echo(item.departlist) + "\">" + echo(item.departname) + "</td>\r\n");
	...
	ViewBuilder.Append("              <td align=\"center\" title=\"" + echo(item.departlist) + "\"><span style=\"color:#ff0000\">" + echo(item.departname) + "</span></td>\r\n");
