<%@ Page language="c#" AutoEventWireup="false" EnableViewState="false" Inherits="FangPage.WMS.Admin.avatarimport" %>
...
protected override void View()
{
	...
	ViewBuilder.Append("<title>批量导入照片</title>\r\n");
	...
	ViewBuilder.Append("        PageNav(\"站点用户管理,user/usermanage.aspx|批量导入照片,user/avatarimport.aspx\");\r\n");
	...
	ViewBuilder.Append("          <td class=\"newstitle\" bgcolor=\"#ffffff\">批量导入照片</td>\r\n");
	ViewBuilder.Append("        </tr>\r\n");
	ViewBuilder.Append("      </tbody>\r\n");
	...
	ViewBuilder.Append("                <tbody>\r\n");
	ViewBuilder.Append("                  <tr>\r\n");
	ViewBuilder.Append("                    <td style=\"height:40px;\" colspan=\"2\">请先把用户的照片传到站点目录下的【avatar】文件夹之下，并以【登录名】或【姓名】做为照片的名称，支持照片格式为：jpg、png、gif。 </td>\r\n");
	ViewBuilder.Append("                  </tr>\r\n");
	ViewBuilder.Append("                  <tr>\r\n");
	ViewBuilder.Append("                    <td class=\"td_class\"></td>\r\n");
	ViewBuilder.Append("                    <td height=\"25\">\r\n");
	ViewBuilder.Append("                    <input type=\"submit\" name=\"btnsave\" value=\"确定导入\" id=\"btnsave\" class=\"adminsubmit_short\">\r\n");
