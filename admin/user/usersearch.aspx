...
protected override void View()
{
	...
	if (role.id!=3)
	{
	ViewBuilder.Append("                            <option value=\"" + echo(role.id) + "\" "+(role.id==s_roleid?"selected":"")+">" + echo(role.name) + "</option>\r\n");
	}//end if
	}//end loop
	...
	{
	loop__id++;
	ViewBuilder.Append("                        <option value=\"" + echo(item.id) + "\" "+(item.id==s_departid?"selected":"")+">├" + echo(item.name) + "</option>\r\n");
	ViewBuilder.Append("                        " + echo(GetChildDepartment(item.id,tree)) + "\r\n");
	}//end loop
	ViewBuilder.Append("                      </select>\r\n");
	ViewBuilder.Append("                      <input id=\"s_depts\" name=\"s_depts\" type=\"checkbox\" "+(s_depts==1?"checked":"")+" value=\"1\">是否包含子部门用户\r\n");
	ViewBuilder.Append("                  </td>\r\n");
	ViewBuilder.Append("                </tr>\r\n");
	ViewBuilder.Append("                <tr>\r\n");
	...
	{
	loop__id++;
	ViewBuilder.Append("<option value=\"" + echo(itme.id) + "\" "+(itme.id==s_gradeid?"selected":"")+">" + echo(itme.name) + "</option>\r\n");
	}//end loop
	ViewBuilder.Append("                      </select>\r\n");
	ViewBuilder.Append("                  </td>\r\n");
	ViewBuilder.Append("                </tr>\r\n");
	...
	{
	loop__id++;
	ViewBuilder.Append("                    <option value=\"" + echo(types2.id) + "\" "+(FPUtils.IsContain(types2.id,s_types)?"selected":"")+">" + echo(types2.name) + "</option>\r\n");
	}//end loop
	ViewBuilder.Append("                    </select>\r\n");
	}//end loop
	ViewBuilder.Append("                </td>\r\n");
	...
	ViewBuilder.Append("                <td>\r\n");
	ViewBuilder.Append("                    <input id=\"s_username\" name=\"s_username\" type=\"checkbox\" "+(s_username==1?"checked":"")+" value=\"1\">用户名\r\n");
	ViewBuilder.Append("                    <input id=\"s_realname\" name=\"s_realname\" type=\"checkbox\" "+(s_realname==1?"checked":"")+" value=\"1\">真实姓名\r\n");
	ViewBuilder.Append("                    <input id=\"s_mobile\" name=\"s_mobile\" type=\"checkbox\" "+(s_mobile==1?"checked":"")+" value=\"1\">手机号码\r\n");
	ViewBuilder.Append("                    <input id=\"s_email\" name=\"s_email\" type=\"checkbox\" "+(s_email==1?"checked":"")+" value=\"1\">电子邮箱\r\n");
	ViewBuilder.Append("                    <input id=\"s_idcard\" name=\"s_idcard\" type=\"checkbox\" "+(s_idcard==1?"checked":"")+" value=\"1\">身份证号\r\n");
	ViewBuilder.Append("                </td>\r\n");
	ViewBuilder.Append("                </tr>\r\n");
	ViewBuilder.Append("                <tr>\r\n");
	ViewBuilder.Append("                  <td class=\"td_class\">登录类型： </td>\r\n");
	ViewBuilder.Append("                  <td>\r\n");
	ViewBuilder.Append("                      <input id=\"s_sso0\" name=\"s_sso\" value=\"0\" "+(s_sso==0?"checked":"")+" type=\"radio\">全部\r\n");
	ViewBuilder.Append("                      <input id=\"s_sso1\" name=\"s_sso\" value=\"1\" "+(s_sso==1?"checked":"")+" type=\"radio\">本地\r\n");
	ViewBuilder.Append("                      <input id=\"s_sso2\" name=\"s_sso\" value=\"2\" "+(s_sso==2?"checked":"")+" type=\"radio\">单点\r\n");
	ViewBuilder.Append("                  </td>\r\n");
	ViewBuilder.Append("                </tr>\r\n");
	ViewBuilder.Append("                <tr>\r\n");
	ViewBuilder.Append("                  <td class=\"td_class\">用户状态： </td>\r\n");
	ViewBuilder.Append("                  <td>\r\n");
	ViewBuilder.Append("                      <input id=\"s_state0\" name=\"s_state\" value=\"0\" "+(s_state==0?"checked":"")+" type=\"radio\">全部\r\n");
	ViewBuilder.Append("                      <input id=\"s_state1\" name=\"s_state\" value=\"1\" "+(s_state==1?"checked":"")+" type=\"radio\">启用\r\n");
	ViewBuilder.Append("                      <input id=\"s_state2\" name=\"s_state\" value=\"2\" "+(s_state==2?"checked":"")+" type=\"radio\">禁用\r\n");
	ViewBuilder.Append("                  </td>\r\n");
	ViewBuilder.Append("                </tr>\r\n");
	ViewBuilder.Append("                <tr>\r\n");
