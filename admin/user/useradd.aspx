...
protected override void View()
{
	...
	ViewBuilder.Append("            <li id=\"one3\" onclick=\"setTab('one',3,3)\" class=\"normal\" style=\"display:"+(id>0?"block":"none")+"\"><a href=\"#\">其他信息</a></li>\r\n");
	ViewBuilder.Append("          </ul>\r\n");
	...
	{
	loop__id++;
	ViewBuilder.Append("                <option value=\"" + echo(item.id) + "\" "+(item.id==fulluserinfo.departid?"selected":"")+">├" + echo(item.name) + "</option>\r\n");
	...
	{
	loop__id++;
	ViewBuilder.Append("                <option value=\"" + echo(itme.id) + "\" "+(itme.id==fulluserinfo.gradeid?"selected":"")+">" + echo(itme.name) + "</option>\r\n");
	}//end loop
	ViewBuilder.Append("              </select>\r\n");
	ViewBuilder.Append("          </td>\r\n");
	ViewBuilder.Append("        </tr>\r\n");
	...
	{
	loop__id++;
	ViewBuilder.Append("            <option value=\"" + echo(types2.id) + "\" "+(FPUtils.IsContain(types2.id,fulluserinfo.types)?"selected":"")+">" + echo(types2.name) + "</option>\r\n");
	}//end loop
	ViewBuilder.Append("            </select>\r\n");
	}//end loop
	ViewBuilder.Append("        </td>\r\n");
	...
	ViewBuilder.Append(" type=\"checkbox\">实名已验证，身份证登录必选\r\n");
	ViewBuilder.Append("          </td>\r\n");
	ViewBuilder.Append("        </tr>\r\n");
	ViewBuilder.Append("        <tr>\r\n");
	...
	ViewBuilder.Append("          <td>\r\n");
	ViewBuilder.Append("              <input type=\"radio\" id=\"sex1\" name=\"sex\" value=\"男\" "+(fulluserinfo.sex=="男"?"checked":"")+">男\r\n");
	ViewBuilder.Append("              <input type=\"radio\" id=\"sex0\" name=\"sex\" value=\"女\" "+(fulluserinfo.sex=="女"?"checked":"")+">女\r\n");
	ViewBuilder.Append("              <input type=\"radio\" id=\"sex2\" name=\"sex\" value=\"\" "+(fulluserinfo.sex==""?"checked":"")+">未知\r\n");
	ViewBuilder.Append("          </td>\r\n");
	ViewBuilder.Append("        </tr>\r\n");
	ViewBuilder.Append("        <tr>\r\n");
	...
	ViewBuilder.Append("        </tr>\r\n");
	ViewBuilder.Append("        <tr>\r\n");
	ViewBuilder.Append("          <td class=\"td_class\">所属籍贯： </td>\r\n");
	ViewBuilder.Append("          <td>\r\n");
	ViewBuilder.Append("              <input style=\"width: 200px\" id=\"origin\" name=\"origin\" value=\"" + echo(fulluserinfo.origin) + "\">\r\n");
	ViewBuilder.Append("          </td>\r\n");
	ViewBuilder.Append("        </tr>\r\n");
	ViewBuilder.Append("        <tr>\r\n");
	...
	ViewBuilder.Append("              <option value=\"小学\" "+(fulluserinfo.education=="小学"?"selected":"")+">小学</option>\r\n");
	ViewBuilder.Append("              <option value=\"初中\" "+(fulluserinfo.education=="初中"?"selected":"")+">初中</option>\r\n");
	ViewBuilder.Append("              <option value=\"高中\" "+(fulluserinfo.education=="高中"?"selected":"")+">高中</option>\r\n");
	ViewBuilder.Append("              <option value=\"大学专科\" "+(fulluserinfo.education=="大学专科"?"selected":"")+">大学专科</option>\r\n");
	ViewBuilder.Append("              <option value=\"大学本科\" "+(fulluserinfo.education=="大学本科"?"selected":"")+">大学本科</option>\r\n");
	ViewBuilder.Append("              <option value=\"硕士\" "+(fulluserinfo.education=="硕士"?"selected":"")+">硕士</option>\r\n");
	ViewBuilder.Append("              <option value=\"博士\" "+(fulluserinfo.education=="博士"?"selected":"")+">博士</option>\r\n");
	ViewBuilder.Append("              </select>\r\n");
	ViewBuilder.Append("          </td>\r\n");
	ViewBuilder.Append("        </tr>\r\n");
	ViewBuilder.Append("        <tr>\r\n");
	ViewBuilder.Append("          <td class=\"td_class\">婚姻状况： </td>\r\n");
	ViewBuilder.Append("          <td>\r\n");
	ViewBuilder.Append("              <select id=\"married\" name=\"married\" style=\"width: 204px\">\r\n");
	ViewBuilder.Append("                <option value=\"\">请选择</option>\r\n");
	ViewBuilder.Append("                <option value=\"未婚\" "+(fulluserinfo.married=="未婚"?"selected":"")+">未婚</option>\r\n");
	ViewBuilder.Append("                <option value=\"已婚\" "+(fulluserinfo.married=="已婚"?"selected":"")+">已婚</option>\r\n");
	ViewBuilder.Append("                <option value=\"初婚\" "+(fulluserinfo.married=="初婚"?"selected":"")+">初婚</option>\r\n");
	ViewBuilder.Append("                <option value=\"再婚\" "+(fulluserinfo.married=="再婚"?"selected":"")+">再婚</option>\r\n");
	ViewBuilder.Append("                <option value=\"复婚\" "+(fulluserinfo.married=="复婚"?"selected":"")+">复婚</option>\r\n");
	ViewBuilder.Append("                <option value=\"丧偶\" "+(fulluserinfo.married=="丧偶"?"selected":"")+">丧偶</option>\r\n");
	ViewBuilder.Append("                <option value=\"离婚\" "+(fulluserinfo.married=="离婚"?"selected":"")+">离婚</option>\r\n");
	ViewBuilder.Append("              </select>\r\n");
	ViewBuilder.Append("          </td>\r\n");
	ViewBuilder.Append("        </tr>\r\n");
	ViewBuilder.Append("        <tr>\r\n");
	ViewBuilder.Append("          <td class=\"td_class\">参加工作时间： </td>\r\n");
	ViewBuilder.Append("          <td>\r\n");
	ViewBuilder.Append("              <input style=\"width: 200px\" id=\"jobdate\" name=\"jobdate\" value=\"" + echo(fulluserinfo.jobdate) + "\">\r\n");
	ViewBuilder.Append("          </td>\r\n");
	ViewBuilder.Append("        </tr>\r\n");
	ViewBuilder.Append("        <tr>\r\n");
	...
	ViewBuilder.Append("          <td>\r\n");
	ViewBuilder.Append("              <img src=\""+(fulluserinfo.avatar!=""?webpath+fulluserinfo.avatar:webpath+"common/avatar/u_avatar.gif")+"\" width=\"100\" style=\"margin:3px;\" height=\"100\">\r\n");
	ViewBuilder.Append("          </td>\r\n");
	ViewBuilder.Append("        </tr>\r\n");
	ViewBuilder.Append("        <tr>\r\n");
