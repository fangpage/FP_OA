                ...
                if(settings.checkbox == true){
                    $(document).on('mouseenter.kanbanView', '#' + id + ' .kanban-card', function () {
                        if(!$(this).parents("li").hasClass('selected')){
                            $(this).append('<div class="check-wrap"><b class="td-checkbox"></b></div>');
                        }
                        return false;
                    });

                    $(document).on('click.kanbanView', '#' + id + ' .kanban-card', function () {
                        if(!$(this).parents("li").hasClass('selected')) {
                            ...
                            $(this).find(".check-wrap").removeClass('selected');
                            $(this).find('.td-checkbox').removeClass('selected');
                        }
