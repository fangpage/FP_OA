<%@ Page language="c#" AutoEventWireup="false" EnableViewState="false" Inherits="FP_FlowUser.selectuser" %>
...
protected override void View()
{
	...
	ViewBuilder.Append("    var DEL_IMG0 = '<img src=\"/plugins/turnuser/images/remove.png\" align=\"absmiddle\" onclick=cancel_user(this,0,\"2\")>';\r\n");
	ViewBuilder.Append("    var DEL_IMG1 = '<img src=\"/plugins/turnuser/images/remove.png\" align=\"absmiddle\" onclick=cancel_user(this,1,\"2\")>';\r\n");
	ViewBuilder.Append("</");
	ViewBuilder.Append("script>\r\n");
	ViewBuilder.Append("</head>\r\n");
	...
	loop__id++;
	ViewBuilder.Append("    <tr class=\"TableData\">\r\n");
	ViewBuilder.Append("      <td title=\"设为主办人\" nowrap=\"\" class=\"menulines_op\" id=\"" + echo(item.id) + "_op\" name=\"" + echo(item.realname) + "\" width=\"80\" align=\"center\" onclick=\"javascript:click_op('" + echo(item.id) + "_op')\" style=\"cursor:pointer\"><input type=\"checkbox\" id=\"opbox_" + echo(item.id) + "\">\r\n");
