<%@ Page language="c#" AutoEventWireup="false" EnableViewState="false" Inherits="FP_FlowUser.index" %>
...
protected override void View()
{
	...
	ViewBuilder.Append("  <iframe id=\"dept\" name=\"dept\" frameborder=\"0\" src=\"dept.aspx?flowid=" + echo(flowid) + "&workid=" + echo(workid) + "\"></iframe>\r\n");
	ViewBuilder.Append("</div>\r\n");
	ViewBuilder.Append("<div id=\"center\">\r\n");
	ViewBuilder.Append("  <iframe id=\"user\" name=\"user\" frameborder=\"0\" src=\"selectuser.aspx?flowid=" + echo(flowid) + "\"></iframe>\r\n");
	ViewBuilder.Append("</div>\r\n");
