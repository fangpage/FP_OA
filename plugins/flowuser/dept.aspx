<%@ Page language="c#" AutoEventWireup="false" EnableViewState="false" Inherits="FP_FlowUser.dept" %>
<%@ Import namespace="System.Collections.Generic" %>
<%@ Import namespace="FangPage.Common" %>
<%@ Import namespace="FangPage.MVC" %>
<%@ Import namespace="FP_FlowUser" %>
...
protected override void View()
{
	...
	ViewBuilder.Append("        parent.user.location = 'selectuser.aspx?intel=' + INTEL + '&flowid=" + echo(flowid) + "&workid=" + echo(workid) + "';\r\n");
	ViewBuilder.Append("    }\r\n");
	...
	ViewBuilder.Append("            parent.user.location = \"selectuser.aspx?flowid=" + echo(flowid) + "&keyword=\" + kword.value;\r\n");
	...
	ViewBuilder.Append("  <img id=\"search_icon\" src=\"images/quicksearch.gif\" align=\"absmiddle\"> </div>\r\n");
	ViewBuilder.Append("<ul>\r\n");
	ViewBuilder.Append("  <li><a href=\"javascript:select_user('1');\" id=\"link_1\"><span>全部经办人</span></a></li>\r\n");
	ViewBuilder.Append("  <li><a href=\"javascript:clickMenu('3');\" id=\"link_2\" class=\"active\" title=\"点击伸缩列表\"><span>按部门选择</span></a></li>\r\n");
	...
	ViewBuilder.Append("          <td align=\"center\" style=\"cursor:pointer\" onclick=\"parent.user.location='selectuser.aspx?deptid=" + echo(departid) + "&flowid=" + echo(flowid) + "'\"><b>本部门</b></td>\r\n");
	...
	loop__id++;
	ViewBuilder.Append("        <tr class=\"TableHeader\">\r\n");
	ViewBuilder.Append("          <td align=\"center\" style=\"cursor:pointer\" onclick=\"parent.user.location='selectuser.aspx?deptid=" + echo(item.id) + "&flowid=" + echo(flowid) + "'\"><b>" + echo(item.name) + "</b></td>\r\n");
	ViewBuilder.Append("        </tr>\r\n");
	}//end loop
	ViewBuilder.Append("      </tbody>\r\n");
