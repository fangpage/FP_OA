<%@ Page language="c#" AutoEventWireup="false" EnableViewState="false" Inherits="FP_Count.Controller.countconfig" %>
<%@ Import namespace="System.Collections.Generic" %>
<%@ Import namespace="FangPage.Common" %>
<%@ Import namespace="FangPage.MVC" %>
<%@ Import namespace="FP_Count" %>
<%@ Import namespace="FP_Count.Model" %>
<script runat="server">
protected override void View()
{
	...
	ViewBuilder.Append("<title>OA计数配置</title>\r\n");
	...
	ViewBuilder.Append("                <th style=\"text-align:center;width:120px\">计数名称</th>\r\n");
	ViewBuilder.Append("                <th style=\"text-align:center;width:60px\">最大计数</th>\r\n");
	ViewBuilder.Append("                <th style=\"text-align:center;\">计数应用</th>\r\n");
	...
	loop__id=0;
	foreach(CountConfig item in countlist)
	{
	loop__id++;
	...
	ViewBuilder.Append("                <td style=\"text-align:center;\"><input name=\"e_name\" id=\"e_name\" type=\"text\" style=\"width:100px;\" value=\"" + echo(item.name) + "\"></td>\r\n");
	...
	ViewBuilder.Append("                <td style=\"text-align:center;\"><input name=\"e_app\" id=\"e_app\" type=\"text\" style=\"width:120px;\" value=\"" + echo(item.app) + "\"></td>\r\n");
	ViewBuilder.Append("                <td style=\"text-align:center;\"><input name=\"e_url\" id=\"e_url\" type=\"text\" style=\"width:120px;\" value=\"" + echo(item.url) + "\"></td>\r\n");
	...
	{
	ViewBuilder.Append("              <tr onmouseover=\"curcolor=this.style.backgroundColor;this.style.backgroundColor='#e2f9de'\" onmouseout=\"this.style.backgroundColor=curcolor\">\r\n");
	ViewBuilder.Append("                <td style=\"text-align:center;\"><input name=\"name\" id=\"name\" type=\"text\" style=\"width:100px;\" value=\"\"></td>\r\n");
	ViewBuilder.Append("                <td style=\"text-align:center;\"><input name=\"maxcount\" id=\"maxcount\" type=\"text\" style=\"width:30px;text-align:center;\" value=\"9\"></td>\r\n");
	ViewBuilder.Append("                <td style=\"text-align:center;\"><input name=\"app\" id=\"app\" type=\"text\" style=\"width:120px;\" value=\"\"></td>\r\n");
	ViewBuilder.Append("                <td style=\"text-align:center;\"><input name=\"url\" id=\"url\" type=\"text\" style=\"width:120px;\" value=\"\"></td>\r\n");
