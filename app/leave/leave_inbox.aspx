<%@ Page language="c#" AutoEventWireup="false" EnableViewState="false" Inherits="FP_Leave.Controller.leave_inbox" %>
...
protected override void View()
{
	...
	ViewBuilder.Append("                                            <a title=\"" + echo(item.title) + "\" class=\"subject\" target=\"_blank\" href=\"workflow.aspx?id=" + echo(item.id) + "\">\r\n");
	ViewBuilder.Append("                                                <img src=\"statics/images/email.png\" style=\"vertical-align: text-bottom; margin-right: 3px;\">" + echo(item.title) + "</a>\r\n");
	ViewBuilder.Append("                                        </td>\r\n");
	ViewBuilder.Append("                                        <td class=\"ellipsis\">\r\n");
	ViewBuilder.Append("                                            <a title=\"\" rel=\"tooltip\" class=\"subject\" target=\"_blank\" href=\"workflow.aspx?id=" + echo(item.id) + "\" data-original-title=\"第" + echo(item.step) + "步：主办\">第" + echo(item.step) + "步：主办</a>\r\n");
	ViewBuilder.Append("                                        </td>\r\n");
	...
	ViewBuilder.Append("                    $(win).find(\".win_title .title\").html('请假申请 -> 待办请假申请')\r\n");
	ViewBuilder.Append("                }\r\n");
	ViewBuilder.Append("            }\r\n");
