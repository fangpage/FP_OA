...
protected override void View()
{
	...
	ViewBuilder.Append("            <span class=\"td-nav-title\" style=\"display: block;\">" + echo(CutString(workinfo.title,30)) + "\r\n");
	...
	{
	ViewBuilder.Append("        <iframe name=\"tab_frame\" id=\"tab_frame\" frameborder=\"0\" noresize=\"noresize\" src=\"flowlist.aspx?id=" + echo(id) + "&action=view\" style=\"height:600px;\"></iframe>\r\n");
	}
	else if (action=="flow")
	{
	ViewBuilder.Append("        <iframe name=\"tab_frame\" id=\"tab_frame\" frameborder=\"0\" noresize=\"noresize\" src=\"flowshow.aspx?id=" + echo(workinfo.id) + "&action=view\" style=\"height:600px;\"></iframe>\r\n");
	}//end if
	ViewBuilder.Append("      </div>\r\n");
	ViewBuilder.Append("    </div>\r\n");
	ViewBuilder.Append("  </div>\r\n");
