<%@ Page language="c#" AutoEventWireup="false" EnableViewState="false" Inherits="FP_Leave.Controller.leave_add" %>
...
protected override void View()
{
	...
	ViewBuilder.Append("<title>请假申请</title>\r\n");
	...
	ViewBuilder.Append("          var url = \"" + echo(plupath) + "stepuser/index.aspx?stepid=" + echo(stepid) + "\";\r\n");
	...
	ViewBuilder.Append("                                <td><span class=\"td-nav-title\">请假申请</span></td>\r\n");
	ViewBuilder.Append("                                <td>\r\n");
	ViewBuilder.Append("                                    <div class=\"pull-right\">\r\n");
	ViewBuilder.Append("                                        <button class=\"btn btn-primary\" id=\"btn_save\" type=\"button\">提交</button>\r\n");
	ViewBuilder.Append("                                        <a href=\"leave_inbox.aspx\" style=\"margin-left:6px;\" class=\"btn btn-danger\">返回</a>\r\n");
	ViewBuilder.Append("                                    </div>\r\n");
	ViewBuilder.Append("                                </td>\r\n");
	ViewBuilder.Append("                            </tr>\r\n");
	ViewBuilder.Append("                        </tbody>\r\n");
	...
	ViewBuilder.Append("                            <tbody>\r\n");
	ViewBuilder.Append("                                <tr>\r\n");
	ViewBuilder.Append("                                    <td style=\"text-align: right\" width=\"150\">\r\n");
	ViewBuilder.Append("                                        <label class=\"control-label required\">开始时间：</label></td>\r\n");
	ViewBuilder.Append("                                    <td style=\"text-align: left;\">\r\n");
	ViewBuilder.Append("                                        <input name=\"starttime\" id=\"starttime\" onfocus=\"WdatePicker({dateFmt:'yyyy-MM-dd'})\" onchange=\"DateDiff($(this).val(),$('#endtime').val())\" readonly=\"readonly\" type=\"text\" style=\"width: 400px;\" maxlength=\"255\" value='" + echo(datetime,"yyyy-MM-dd") + "'></td>\r\n");
	ViewBuilder.Append("                                </tr>\r\n");
	ViewBuilder.Append("                                <tr>\r\n");
	ViewBuilder.Append("                                    <td style=\"text-align: right\" width=\"150\">\r\n");
	ViewBuilder.Append("                                        <label class=\"control-label required\">结束时间：</label></td>\r\n");
	ViewBuilder.Append("                                    <td style=\"text-align: left;\">\r\n");
	ViewBuilder.Append("                                        <input name=\"endtime\" id=\"endtime\" type=\"text\" onfocus=\"WdatePicker({dateFmt:'yyyy-MM-dd'})\" onchange=\"DateDiff($('#starttime').val(),$(this).val())\" readonly=\"readonly\" style=\"width: 400px;\" maxlength=\"255\" value='" + echo(datetime,"yyyy-MM-dd") + "'></td>\r\n");
	ViewBuilder.Append("                                </tr>\r\n");
	ViewBuilder.Append("                                <tr>\r\n");
	ViewBuilder.Append("                                    <td style=\"text-align: right\" width=\"150\">\r\n");
	ViewBuilder.Append("                                        <label class=\"control-label required\">请假天数：</label></td>\r\n");
	ViewBuilder.Append("                                    <td style=\"text-align: left;\">\r\n");
	ViewBuilder.Append("                                        <input name=\"days\" id=\"days\" type=\"text\" style=\"width: 400px;\" maxlength=\"255\" readonly=\"readonly\" value=\"1\"></td>\r\n");
	ViewBuilder.Append("                                </tr>\r\n");
	ViewBuilder.Append("                                <tr>\r\n");
	ViewBuilder.Append("                                    <td style=\"text-align: right\" width=\"150\">\r\n");
	ViewBuilder.Append("                                        <label class=\"control-label required\">请假类型：</label></td>\r\n");
	ViewBuilder.Append("                                    <td style=\"text-align: left;\">\r\n");
	ViewBuilder.Append("                                      <select id=\"type\" name=\"type\" style=\"width:403px;\">\r\n");
	ViewBuilder.Append("                                        <option valu=\"\">请选择请假类型</option>\r\n");
	ViewBuilder.Append("                                        <option valu=\"公休\">公休</option>\r\n");
	ViewBuilder.Append("                                        <option valu=\"探亲\">探亲</option>\r\n");
	ViewBuilder.Append("                                        <option valu=\"病假\">病假</option>\r\n");
	ViewBuilder.Append("                                        <option valu=\"事假\">事假</option>\r\n");
	ViewBuilder.Append("                                        <option valu=\"其他\">其他</option>\r\n");
	ViewBuilder.Append("                                      </select>\r\n");
	ViewBuilder.Append("                                    </td>\r\n");
	ViewBuilder.Append("                                </tr>\r\n");
	ViewBuilder.Append("                                <tr>\r\n");
	ViewBuilder.Append("                                    <td style=\"text-align: right\" width=\"150\">\r\n");
	ViewBuilder.Append("                                      <label class=\"control-label required\">请假事由及<br>前往地点：</label></td>\r\n");
	ViewBuilder.Append("                                    <td style=\"text-align: left;\">\r\n");
	ViewBuilder.Append("                                       <textarea id=\"reason\" name=\"reason\" style=\"width: 800px; height: 300px\" cols=\"20\" rows=\"2\"></textarea>\r\n");
	ViewBuilder.Append("                                    </td>\r\n");
	ViewBuilder.Append("                                </tr>\r\n");
	ViewBuilder.Append("                                <tr>\r\n");
	ViewBuilder.Append("                                    <td style=\"text-align: right\" width=\"150\">\r\n");
	ViewBuilder.Append("                                        <label class=\"control-label required\">选择审批人：</label></td>\r\n");
	ViewBuilder.Append("                                    <td style=\"text-align: left;\">\r\n");
	...
	ViewBuilder.Append("                                                </div>\r\n");
	ViewBuilder.Append("                                            </div>\r\n");
	ViewBuilder.Append("                                            <div id=\"prcs_op_block_div2\" class=\"clearfix\" style=\"margin: 5px 0;display:none;\">\r\n");
	...
	ViewBuilder.Append("                                            </div>\r\n");
	ViewBuilder.Append("                                        </div>\r\n");
	ViewBuilder.Append("                                        <a style=\"margin: 0 4px; vertical-align: bottom;\" class=\"btn btn-success btn-small\" id=\"btn_selector\">选择审批人</a>\r\n");
	...
	ViewBuilder.Append("    <script type=\"text/javascript\">\r\n");
	ViewBuilder.Append("      $(function () {\r\n");
	ViewBuilder.Append("            var flowid=" + echo(flowid) + ";\r\n");
	ViewBuilder.Append("            $(\"#btn_save\").click(function () {\r\n");
	ViewBuilder.Append("              if(flowid==0)\r\n");
	ViewBuilder.Append("              {\r\n");
	ViewBuilder.Append("                alert(\"对不起，您尚未设定请假流程。\")\r\n");
	ViewBuilder.Append("              }\r\n");
	...
	ViewBuilder.Append("              if ($(\"#reason\").val() == \"\") {\r\n");
	ViewBuilder.Append("                alert(\"请假事由不能为空!\");\r\n");
	...
	ViewBuilder.Append("            });\r\n");
	ViewBuilder.Append("        });\r\n");
	ViewBuilder.Append("        //计算天数差\r\n");
	ViewBuilder.Append("        function DateDiff(sDate1, sDate2) {    //sDate1和sDate2是2006-12-18格式  \r\n");
	ViewBuilder.Append("          var aDate, oDate1, oDate2, iDays\r\n");
	ViewBuilder.Append("          aDate = sDate1.split(\"-\")\r\n");
	ViewBuilder.Append("          oDate1 = new Date(aDate[1] + '-' + aDate[2] + '-' + aDate[0])    //转换为12-18-2006格式  \r\n");
	ViewBuilder.Append("          aDate = sDate2.split(\"-\")\r\n");
	ViewBuilder.Append("          oDate2 = new Date(aDate[1] + '-' + aDate[2] + '-' + aDate[0])\r\n");
	ViewBuilder.Append("          iDays = parseInt(Math.abs(oDate1 - oDate2) / 1000 / 60 / 60 / 24) + 1    //把相差的毫秒数转换为天数  \r\n");
	ViewBuilder.Append("          $(\"#days\").val(iDays);\r\n");
	ViewBuilder.Append("        }\r\n");
	ViewBuilder.Append("    </");
	ViewBuilder.Append("script>\r\n");
