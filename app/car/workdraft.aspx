...
protected override void View()
{
	...
	ViewBuilder.Append("          <td><span class=\"td-nav-title\">新建车辆申请表</span></td>\r\n");
	...
	if (item.desc!="")
	{
	ViewBuilder.Append("              <p class=\"view-item-desc ellipsis\">" + echo(item.desc) + "</p>\r\n");
	}
	else
	{
	ViewBuilder.Append("              <p class=\"view-item-desc ellipsis\">暂无文本</p>\r\n");
	}//end if
	ViewBuilder.Append("            </div>\r\n");
	...
	if (item.type==1)
	{
	ViewBuilder.Append("                <a class=\"subject btn btn-success\" href=\"taskadd.aspx?flowid=" + echo(item.id) + "\">新建申请</a>\r\n");
	}
	else
	{
	ViewBuilder.Append("                <a class=\"btn btn-success\" href=\"workadd.aspx?flowid=" + echo(item.id) + "\">新建申请</a>\r\n");
	}//end if
	ViewBuilder.Append("            </div>\r\n");
	ViewBuilder.Append("          </div>\r\n");
	ViewBuilder.Append("        </div>\r\n");
