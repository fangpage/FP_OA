...
protected override void View()
{
	...
	if (istitle)
	{
	ViewBuilder.Append("        $(\".td-nav .td-nav-title\").dblclick(function () {\r\n");
	...
	ViewBuilder.Append("            });\r\n");
	ViewBuilder.Append("            $(this).hide();\r\n");
	ViewBuilder.Append("            $(\".td-nav .td-nav-title\").text('工作标题：'+$(this).val()).show();\r\n");
	ViewBuilder.Append("        })\r\n");
	...
	if (istitle)
	{
	ViewBuilder.Append("            <span class=\"td-nav-title\" style=\"display: block;\" title=\"双击可以修改标题\"><span style=\"font-weight:bold;\">公文标题：</span>" + echo(workinfo.title) + "</span>\r\n");
	ViewBuilder.Append("            <form style=\"margin:0px;\" class=\"form-inline\" id=\"titleform\" action=\"\" method=\"post\">\r\n");
	ViewBuilder.Append("              <input style=\"width: 100%; display: none;\" placeholder=\"公文标题\" name=\"title\" id=\"title\" type=\"text\" maxlength=\"255\" value=\"" + echo(workinfo.title) + "\">\r\n");
	ViewBuilder.Append("            </form>\r\n");
	}
	else
	{
	ViewBuilder.Append("            <span class=\"td-nav-title\" style=\"display: block;\">公文标题：" + echo(workinfo.title) + "</span>\r\n");
	}//end if
	ViewBuilder.Append("          </td>\r\n");
	ViewBuilder.Append("          <td>\r\n");
	...
	{
	ViewBuilder.Append("                  <a style=\"margin-right:3px;\" class=\"btn btn-primary\" id=\"btn_save\">保存</a>\r\n");
	ViewBuilder.Append("                  <a style=\"margin-right:3px;\" class=\"btn btn-danger\" id=\"btn_turn\">转交</a>\r\n");

	if (workinfo.isback==0&&workinfo.uid==0)
	{
	ViewBuilder.Append("                  <a style=\"margin-right:3px;\" class=\"btn btn-primary\" id=\"btn_back\">回退</a>\r\n");
	}//end if
	}
	else
	{
	ViewBuilder.Append("                  <a style=\"margin-right:3px;\" class=\"btn btn-primary\" id=\"btn_save\">保存</a>\r\n");
	ViewBuilder.Append("                  <a style=\"margin-right:3px;\" class=\"btn btn-danger\" id=\"btn_end\">办结</a>\r\n");
	}//end if
	...
	ViewBuilder.Append("                    <label for=\"ismsg1\">发送内部提醒消息</label>\r\n");
	ViewBuilder.Append("                    </label>\r\n");
	ViewBuilder.Append("                    <label class=\"checkbox inline\">\r\n");
	ViewBuilder.Append("                    <input id=\"issms1\" style=\"margin-top:4px;\" type=\"checkbox\" value=\"1\" name=\"issms\">\r\n");
	ViewBuilder.Append("                    <label for=\"issms1\">发送短信提醒消息</label>\r\n");
	ViewBuilder.Append("                    </label>\r\n");
	ViewBuilder.Append("                    </label>\r\n");
	...
	ViewBuilder.Append("            <label class=\"checkbox inline\">\r\n");
	ViewBuilder.Append("            <label class=\"checkbox inline\">\r\n");
	ViewBuilder.Append("            <input id=\"ismsg\" style=\"margin-top:4px;\" type=\"checkbox\" value=\"1\" checked=\"checked\" name=\"ismsg\">\r\n");
	ViewBuilder.Append("            <label for=\"ismsg\">发送内部提醒消息</label>\r\n");
	ViewBuilder.Append("            </label>\r\n");
	ViewBuilder.Append("            <label class=\"checkbox inline\">\r\n");
	ViewBuilder.Append("            <input id=\"issms\" style=\"margin-top:4px;\" type=\"checkbox\" value=\"1\" name=\"issms\">\r\n");
	ViewBuilder.Append("            <label for=\"issms\">发送短信提醒消息</label>\r\n");
	ViewBuilder.Append("            </label>\r\n");
	ViewBuilder.Append("            </label>\r\n");
	...
	ViewBuilder.Append("            var nodeType = $(this).attr('node-type');\r\n");
	ViewBuilder.Append("            var canChange;\r\n");
	ViewBuilder.Append("            //已选择取消温馨提示\r\n");
	...
	ViewBuilder.Append("            }\r\n");
	ViewBuilder.Append("            if ($(this).parent().attr('disabled')) {\r\n");
	ViewBuilder.Append("                window._originalAlert('有并发流程没有办结，流程不能转交！');\r\n");
	ViewBuilder.Append("                return false;\r\n");
	ViewBuilder.Append("            }\r\n");
