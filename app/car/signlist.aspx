<%@ Page language="c#" AutoEventWireup="false" EnableViewState="false" Inherits="FP_WorkFlow.Controller.signlist" %>
...
protected override void View()
{
	...
	ViewBuilder.Append("<title>会签快捷输入</title>\r\n");
	...
	ViewBuilder.Append("                <th style=\"width:80px;text-align:center;\">选择会签快捷输入(最新20条)</th>\r\n");
	ViewBuilder.Append("              </tr>\r\n");
	ViewBuilder.Append("            </thead>\r\n");
	ViewBuilder.Append("            <tbody>\r\n");

	loop__id=0;
	foreach(SignInfo item in _signlist)
	{
	loop__id++;
	...
	ViewBuilder.Append("                <td style=\"text-align:left;cursor:pointer;\" onclick=\"click_sign(this)\"><span>" + echo(item.content) + "</span></td>\r\n");
	ViewBuilder.Append("              </tr>\r\n");
	}//end loop
	ViewBuilder.Append("            </tbody>\r\n");
	...
	ViewBuilder.Append("    function click_sign(obj)\r\n");
	ViewBuilder.Append("    {\r\n");
	ViewBuilder.Append("        var back_fill_value = jQuery(obj).find('span').html();\r\n");
	ViewBuilder.Append("        parent.QuickInput(back_fill_value);\r\n");
