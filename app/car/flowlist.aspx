...
protected override void View()
{
	...
	ViewBuilder.Append("            <th style=\"width: 60px;text-align:center\">流转步骤</th>\r\n");
	ViewBuilder.Append("            <th style=\"text-align:center;width:200px;\">步骤名称</th>\r\n");
	...
	ViewBuilder.Append("                <img alt=\"\" src=\"statics/images/next.gif\" width=\"16\" height=\"16\">序号" + echo(item.step_number) + ":" + echo(item.stepname) + "\r\n");
	ViewBuilder.Append("            </td>\r\n");
	ViewBuilder.Append("            <td>\r\n");
	...
	if (item2.status==0)
	{
	ViewBuilder.Append("               <p><img src=\"statics/images/email.png\" style=\"vertical-align:text-bottom;margin-right:3px;\"><font color=\"#dd4b39\">" + echo(item2.receive_name) + "&nbsp;" + echo(item2.isadmin_show) + "</font>\r\n");
	ViewBuilder.Append("                [<font color=\"#51a351\">未接收</font>]</p>\r\n");
	}
	else if (item2.status==1)
	{
	ViewBuilder.Append("               <p><img src=\"statics/images/email_open.png\" style=\"vertical-align:text-bottom;margin-right:3px;\"><font color=\"#dd4b39\">" + echo(item2.receive_name) + "&nbsp;" + echo(item2.isadmin_show) + "</font>\r\n");
	...
	{
	ViewBuilder.Append("                <p><img src=\"statics/images/email_open_image.png\" style=\"vertical-align:text-bottom;margin-right:3px;\"><font color=\"#dd4b39\">" + echo(item2.receive_name) + "&nbsp;主办</font>\r\n");
	...
	{
	ViewBuilder.Append("               <p><img src=\"statics/images/email_open_image.png\" style=\"vertical-align:text-bottom;margin-right:3px;\"><font color=\"#dd4b39\">" + echo(item2.receive_name) + "&nbsp;" + echo(item2.isadmin_show) + "</font>\r\n");
