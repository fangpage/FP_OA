<%@ Page language="c#" AutoEventWireup="false" EnableViewState="false" Inherits="FP_WorkFlow.Controller.workinbox" %>
...
protected override void View()
{
	...
	ViewBuilder.Append("    <title>待办车辆申请</title>\r\n");
	...
	ViewBuilder.Append("><a href=\"worknew.aspx\"><i class=\"icon-pencil-2\"></i>新建车辆申请</a></li>\r\n");
	}//end if
	ViewBuilder.Append("        <li \r\n");
	...
	ViewBuilder.Append("><a href=\"workinbox.aspx\"><i class=\"icon-clock-3\"></i>待办车辆申请<span class=\"badge badge-important pull-right\">" + echo(countinfo.count) + "</span></a></li>\r\n");
	ViewBuilder.Append("        <li \r\n");
	...
	ViewBuilder.Append("><a href=\"worklist.aspx\"><i class=\"icon-file\"></i>已办车辆申请</a></li>\r\n");
	ViewBuilder.Append("        <li \r\n");

	if (pagename=="workquery.aspx")
	{
	ViewBuilder.Append(" class=\"active\" \r\n");
	}//end if
	ViewBuilder.Append("><a href=\"workquery.aspx\"><i class=\"icon-file\"></i>车辆申请查询</a></li>\r\n");
	...
	ViewBuilder.Append("                                <td><span class=\"td-nav-title\">待办车辆申请</span></td>\r\n");
	...
	ViewBuilder.Append("                <label class=\"control-label\" for=\"title\">申请标题</label>\r\n");
	...
	{
	ViewBuilder.Append("            <div class=\"control-group \">\r\n");
	ViewBuilder.Append("                <label class=\"control-label\" for=\"title\">申请类型</label>\r\n");
	ViewBuilder.Append("                <div class=\"controls\">\r\n");
	...
	{
	ViewBuilder.Append("            <div class=\"control-group \">\r\n");
	ViewBuilder.Append("                <label class=\"control-label\" for=\"title\">申请分类</label>\r\n");
	ViewBuilder.Append("                <div class=\"controls\">\r\n");
	...
	ViewBuilder.Append("                                    <tr>\r\n");
	ViewBuilder.Append("                                        <th class=\"ellipsis\">申请标题</th>\r\n");
	ViewBuilder.Append("                                        <th style=\"text-align: center; width: 100px;\">流程步骤</th>\r\n");
	ViewBuilder.Append("                                        <th style=\"text-align: center; width: 100px;\">发起人</th>\r\n");
	...
	{
	ViewBuilder.Append("                                            <a title=\"\" rel=\"tooltip\" class=\"subject\" target=\"_blank\" href=\"taskview.aspx?id=" + echo(item.id) + "\" data-original-title=\"" + echo(item.title) + "" + echo(astr) + "\">\r\n");
	ViewBuilder.Append("                                                <img src=\"statics/images/" + echo(ostr) + "\" style=\"vertical-align: text-bottom; margin-right: 3px;\">" + echo(item.title) + "" + echo(astr) + "</a>\r\n");
	}
	else if (item.type==1&&item.uid==userid)
	{
	ViewBuilder.Append("                                            <a title=\"\" rel=\"tooltip\" class=\"subject\" target=\"_blank\" href=\"taskadd.aspx?id=" + echo(item.id) + "\" data-original-title=\"" + echo(item.title) + "" + echo(astr) + "\">\r\n");
	ViewBuilder.Append("                                                <img src=\"statics/images/" + echo(ostr) + "\" style=\"vertical-align: text-bottom; margin-right: 3px;\">" + echo(item.title) + "" + echo(astr) + "</a>\r\n");
	}
	else
	{
	ViewBuilder.Append("                                            <a title=\"\" rel=\"tooltip\" class=\"subject\" target=\"_blank\" href=\"workflow.aspx?id=" + echo(item.id) + "\" data-original-title=\"" + echo(item.title) + "" + echo(astr) + "\">\r\n");
	ViewBuilder.Append("                                                <img src=\"statics/images/" + echo(ostr) + "\" style=\"vertical-align: text-bottom; margin-right: 3px;\">" + echo(item.title) + "" + echo(astr) + "</a>\r\n");
	}//end if

	if (item.isfav==1)
	{
	ViewBuilder.Append("                                            <i class=\"icon-star\"></i>\r\n");
	}//end if
	ViewBuilder.Append("                                        </td>\r\n");
	ViewBuilder.Append("                                        <td class=\"ellipsis\">\r\n");

	if (item.type==1&&item.uid==0&&item.isadmin==1)
	{
	ViewBuilder.Append("                                            <a title=\"\" rel=\"tooltip\" class=\"subject\" target=\"_blank\" href=\"taskview.aspx?id=" + echo(item.id) + "\" data-original-title=\"第" + echo(item.step) + "步：主办\">第" + echo(item.step) + "步：主办</a>\r\n");
	}
	else if (item.type==1&&item.uid==0&&item.isadmin==0)
	{
	ViewBuilder.Append("                                            <a title=\"\" rel=\"tooltip\" class=\"subject\" target=\"_blank\" href=\"taskview.aspx?id=" + echo(item.id) + "\" data-original-title=\"第" + echo(item.step) + "步：协办\">第" + echo(item.step) + "步：协办</a>\r\n");
	}
	else if (item.type==1&&item.uid==userid)
	{
	ViewBuilder.Append("                                            <a title=\"\" rel=\"tooltip\" class=\"subject\" target=\"_blank\" href=\"taskadd.aspx?id=" + echo(item.id) + "\" data-original-title=\"第" + echo(item.step) + "步：发起\">第" + echo(item.step) + "步：发起</a>\r\n");
	}
	else
	{
	ViewBuilder.Append("                                            <a title=\"\" rel=\"tooltip\" class=\"subject\" target=\"_blank\" href=\"workflow.aspx?id=" + echo(item.id) + "&&action=flowlist\" data-original-title=\"第" + echo(item.step) + "步：" + echo(item.stepname) + "\">第" + echo(item.step) + "步：" + echo(item.stepname) + "</a>\r\n");
	}//end if
	ViewBuilder.Append("                                        </td>\r\n");
	ViewBuilder.Append("                                        <td class=\"ellipsis\" style=\"text-align: center;\">" + echo(item.rawname) + "</td>\r\n");
	...
	if (item.type==1&&item.uid==0)
	{
	ViewBuilder.Append("                                            <a class=\"subject td-link-icon\" href=\"taskview.aspx?id=" + echo(item.id) + "\"><i class=\"icon-pencil-5\"></i>" + echo(instr) + "</a>\r\n");
	}
	else if (item.type==1&&item.uid==userid)
	{
	ViewBuilder.Append("                                            <a class=\"subject td-link-icon\" href=\"taskadd.aspx?id=" + echo(item.id) + "\"><i class=\"icon-pencil-5\"></i>" + echo(instr) + "</a>\r\n");
	}
	else
	{
	ViewBuilder.Append("                                            <a class=\"subject td-link-icon\" href=\"workflow.aspx?id=" + echo(item.id) + "\"><i class=\"icon-pencil-5\"></i>" + echo(instr) + "</a>\r\n");
	}//end if

	if (item.isadmin==1)
	{
	ViewBuilder.Append("                                            <span style=\"color: #dcdbdb\"><i class=\"icon-arrow-5\"></i>委托</span>\r\n");
	}
	else
	{
	ViewBuilder.Append("                                            <span style=\"color: #dcdbdb\"><i class=\"icon-arrow-5\"></i>委托</span>\r\n");
