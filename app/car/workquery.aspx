<%@ Page language="c#" AutoEventWireup="false" EnableViewState="false" Inherits="FP_WorkFlow.Controller.workquery" %>
...
protected override void View()
{
	...
	ViewBuilder.Append("<title>车辆申请查询</title>\r\n");
	...
	ViewBuilder.Append("              <td><span class=\"td-nav-title\">车辆申请查询</span></td>\r\n");
	...
	ViewBuilder.Append("                <th style=\"text-align:center;width:120px;\">流程步骤</th>\r\n");
	ViewBuilder.Append("                <th style=\"text-align:center;width:60px;\">发起人</th>\r\n");
	...
	ViewBuilder.Append("                <th style=\"width:100px;text-align:center;\">操作</th>\r\n");
	ViewBuilder.Append("              </tr>\r\n");
	ViewBuilder.Append("            </thead>\r\n");
	...
	if (item.type==1)
	{
	ViewBuilder.Append("                    <a title=\"\" rel=\"tooltip\" class=\"subject\" href=\"taskview.aspx?id=" + echo(item.id) + "\" data-original-title=\"" + echo(item.title) + "" + echo(astr) + "\"><i class=\"ico-send\"></i>&nbsp;" + echo(item.title) + "" + echo(astr) + "</a>\r\n");
	}
	else
	{
	ViewBuilder.Append("                    <a title=\"\" rel=\"tooltip\" class=\"subject\" href=\"workview.aspx?id=" + echo(item.id) + "\" data-original-title=\"" + echo(item.title) + "" + echo(astr) + "\"><i class=\"ico-send\"></i>&nbsp;" + echo(item.title) + "" + echo(astr) + "</a>\r\n");
	}//end if
	...
	if (item.type==1)
	{
	ViewBuilder.Append("                   <a title=\"\" rel=\"tooltip\" class=\"subject\" href=\"taskview.aspx?id=" + echo(item.id) + "\" data-original-title=\"第" + echo(item.step) + "步：" + FPUtils.RemoveHtml(item.content) + "\">第" + echo(item.step) + "步：" + FPUtils.RemoveHtml(item.content) + "</a>\r\n");
	}
	else
	{
	ViewBuilder.Append("                   <a title=\"\" rel=\"tooltip\" class=\"subject\" href=\"workview.aspx?id=" + echo(item.id) + "&action=flowlist\" data-original-title=\"第" + echo(item.step) + "步：" + echo(item.stepname) + "\">第" + echo(item.step) + "步：" + echo(item.stepname) + "</a>\r\n");
	}//end if
	ViewBuilder.Append("                </td>\r\n");
	...
	ViewBuilder.Append("                $(win).find(\".win_title .title\").html('公文办理 -> 已办理公文')\r\n");
	ViewBuilder.Append("            }\r\n");
	ViewBuilder.Append("        }\r\n");
