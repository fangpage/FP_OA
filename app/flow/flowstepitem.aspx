<%@ Page language="c#" AutoEventWireup="false" EnableViewState="false" Inherits="FP_Flow.Controller.flowstepitem" %>
...
protected override void View()
{
	...
	ViewBuilder.Append("    <title>步骤主办字段</title>\r\n");
	...
	ViewBuilder.Append("            PageNav('" + echo(GetSortNav(sortinfo,"flowmanage.aspx")) + "|主办字段," + echo(rawurl) + "');\r\n");
	...
	ViewBuilder.Append("                    <li class=\"active\"><a href=\"flowstepitem.aspx?stepid=" + echo(stepid) + "\">主办字段</a> </li>\r\n");
	...
	ViewBuilder.Append("                        <tbody>\r\n");
	ViewBuilder.Append("                            <tr>\r\n");
	ViewBuilder.Append("                                <td class=\"newstitle\" bgcolor=\"#ffffff\">步骤可写字段：" + echo(flowstepinfo.name) + "</td>\r\n");
	ViewBuilder.Append("                            </tr>\r\n");
	ViewBuilder.Append("                        </tbody>\r\n");
	...
	ViewBuilder.Append("			                    <tr>\r\n");
	ViewBuilder.Append("				                    <td align=\"center\">本步骤主办可写字段</td>\r\n");
	...
	if (FPUtils.IsContain(item.id,flowstepinfo.prcsitem))
	{
	ViewBuilder.Append("<option value=\"" + echo(item.id) + "\">" + echo(item.name) + "</option>\r\n");
	}//end if
	}//end loop

	if (FPUtils.IsContain(-1,flowstepinfo.prcsitem))
	{
	ViewBuilder.Append("<option value=\"-1\">工作标题</option>\r\n");
	}//end if
