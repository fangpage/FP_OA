<%@ Page language="c#" AutoEventWireup="false" EnableViewState="false" Inherits="FP_Flow.Controller.usersearch" %>
...
protected override void View()
{
	...
	ViewBuilder.Append("        <input id=\"keyword\" name=\"keyword\" value=\"" + echo(keyword) + "\" type=\"text\" style=\"width:120px;\">\r\n");
	...
	ViewBuilder.Append("               <td>\r\n");
	ViewBuilder.Append("                   <input id=\"chkid\" name=\"chkid\" value=\"" + echo(item.id) + "\" "+(FPUtils.IsContain(item.id,users)?"checked":"")+" type=\"checkbox\">\r\n");
	ViewBuilder.Append("               </td>\r\n");
