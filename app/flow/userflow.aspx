<%@ Page language="c#" AutoEventWireup="false" EnableViewState="false" Inherits="FP_Flow.Controller.userflow" %>
...
protected override void View()
{
	...
	ViewBuilder.Append("  <input id=\"users\" name=\"users\" value=\"" + echo(users) + "\" type=\"hidden\">\r\n");
	...
	ViewBuilder.Append("               <td><a href=\"javascript:DeleteUser(" + echo(item.id) + ")\">删除</a></td>\r\n");
	ViewBuilder.Append("            </tr>\r\n");
	}//end loop
	ViewBuilder.Append("          </tbody>\r\n");
