<%@ Page language="c#" AutoEventWireup="false" EnableViewState="false" Inherits="FP_Flow.Controller.flowflag" %>
...
protected override void View()
{
	...
	ViewBuilder.Append("    <title>流程权限</title>\r\n");
	...
	ViewBuilder.Append("                users: '" + echo(flowinfo.users) + "'\r\n");
	...
	ViewBuilder.Append("                    <li class=\"normal\"><a href=\"flowadd.aspx?id=" + echo(id) + "\">流程属性</a> </li>\r\n");
	ViewBuilder.Append("                    <li class=\"active\"><a href=\"flowflag.aspx?id=" + echo(id) + "\">流程权限</a> </li>\r\n");
	...
	ViewBuilder.Append("                        <tbody>\r\n");
	ViewBuilder.Append("                            <tr>\r\n");
	ViewBuilder.Append("                                <td class=\"newstitle\" bgcolor=\"#ffffff\">流程权限：" + echo(flowinfo.name) + "</td>\r\n");
	ViewBuilder.Append("                            </tr>\r\n");
	ViewBuilder.Append("                        </tbody>\r\n");
	...
	{
	ViewBuilder.Append("                            <input id=\"roles\" name=\"roles\" value=\"" + echo(roles.id) + "\" "+(FPUtils.IsContain(roles.id,flowinfo.roles)?"checked":"")+" type=\"checkbox\">" + echo(roles.name) + "\r\n");
	}//end if
	}//end loop
	ViewBuilder.Append("                        </td>\r\n");
	ViewBuilder.Append("                    </tr>\r\n");
	...
	{
	loop__id++;
	ViewBuilder.Append("                              <input id=\"grades\" name=\"grades\" value=\"" + echo(item.id) + "\" "+(FPUtils.IsContain(item.id,flowinfo.grades)?"checked":"")+" type=\"checkbox\">" + echo(item.name) + "\r\n");
	}//end loop
	ViewBuilder.Append("                        </td>\r\n");
	ViewBuilder.Append("                    </tr>\r\n");
	ViewBuilder.Append("                    <tr>\r\n");
	...
	ViewBuilder.Append("                        <td height=\"25\">\r\n");
	ViewBuilder.Append("                            <input id=\"users\" name=\"users\" value=\"" + echo(flowinfo.users) + "\" type=\"hidden\">\r\n");
	...
	ViewBuilder.Append("            <input type=\"button\" name=\"btnok\" value=\"确定\" id=\"btnok\" class=\"btn btn-primary\">\r\n");
	ViewBuilder.Append("            <input type=\"button\" name=\"btnclose\" value=\"关闭\" id=\"btnclose\" class=\"btn\">\r\n");
	ViewBuilder.Append("            </td>\r\n");
	ViewBuilder.Append("            </tr>\r\n");
	ViewBuilder.Append("      </table>\r\n");
	ViewBuilder.Append("	</div>\r\n");
