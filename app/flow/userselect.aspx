<%@ Page language="c#" AutoEventWireup="false" EnableViewState="false" Inherits="FP_Flow.Controller.userselect" %>
...
protected override void View()
{
	...
	ViewBuilder.Append("                    }\r\n");
	ViewBuilder.Append("                })\r\n");
	ViewBuilder.Append("                var users=parent.$('#users').val();\r\n");
	ViewBuilder.Append("                if(users!='')\r\n");
	ViewBuilder.Append("                {\r\n");
	ViewBuilder.Append("                    users+=\",\";\r\n");
	ViewBuilder.Append("                }\r\n");
	ViewBuilder.Append("                users+=str;\r\n");
	ViewBuilder.Append("                $.post(\"userajax.aspx\", {\r\n");
	ViewBuilder.Append("                    users: users\r\n");
	ViewBuilder.Append("                }, function (data) {\r\n");
	ViewBuilder.Append("                    parent.$(\"#usernames\").html(data.uname);\r\n");
	ViewBuilder.Append("                    parent.$('#users').val(data.uidlist);\r\n");
	ViewBuilder.Append("                    parent.layer.close(index);\r\n");
	ViewBuilder.Append("                }, \"json\");\r\n");
	ViewBuilder.Append("            })\r\n");
	ViewBuilder.Append("            $(\"#btnuserok\").click(function () {\r\n");
	ViewBuilder.Append("                var users=$(\"#users\",window.frames[\"frmmaindetail\"].document).val();\r\n");
	ViewBuilder.Append("                $.post(\"userajax.aspx\", {\r\n");
	ViewBuilder.Append("                    users: users\r\n");
	ViewBuilder.Append("                }, function (data) {\r\n");
	ViewBuilder.Append("                    parent.$(\"#usernames\").html(data.uname);\r\n");
	...
	if (tab==0)
	{
	ViewBuilder.Append("              <li class=\"active\"><a href=\"userselect.aspx?tab=0&users=" + echo(users) + "\">选择用户</a></li>\r\n");
	}
	else
	{
	ViewBuilder.Append("              <li class=\"normal\"><a href=\"userselect.aspx?tab=0&users=" + echo(users) + "\">选择用户</a></li>\r\n");
	}//end if

	if (tab==1)
	{
	ViewBuilder.Append("              <li class=\"active\"><a href=\"userselect.aspx?tab=1&users=" + echo(users) + "\">已选用户</a></li>\r\n");
	}
	else
	{
	ViewBuilder.Append("              <li class=\"normal\"><a href=\"userselect.aspx?tab=1&users=" + echo(users) + "\">已选用户</a></li>\r\n");
	}//end if
	ViewBuilder.Append("          </ul>\r\n");
	...
	ViewBuilder.Append("            <td style=\"border: solid 1px #93C7D4; vertical-align: top;\">\r\n");
	ViewBuilder.Append("                <div style=\"padding: 2px;\">\r\n");
	ViewBuilder.Append("                    <iframe id=\"frmmaindetail\" name=\"frmmaindetail\" src=\"userflow.aspx?tab=" + echo(tab) + "&users=" + echo(users) + "\" frameborder=\"0\" scrolling=\"auto\" style=\"width: 100%;\"></iframe>\r\n");
	ViewBuilder.Append("                </div>\r\n");
	...
	ViewBuilder.Append("                        <li style=\"background: url(images/down.gif) 2px 6px no-repeat\"><a id=\"btnexpandall\" href=\"javascript:void();\">展开</a></li>\r\n");
	ViewBuilder.Append("                        <li style=\"background: url(images/up.gif) 2px 6px no-repeat\"><a id=\"btncollapseall\" href=\"javascript:void();\">收缩</a></li>\r\n");
	ViewBuilder.Append("                    </ul>\r\n");
	ViewBuilder.Append("                </div>\r\n");
	ViewBuilder.Append("                </div>\r\n");
	...
	ViewBuilder.Append("            <td style=\"border: solid 1px #93C7D4; vertical-align: top;\">\r\n");
	ViewBuilder.Append("                <div style=\"padding: 2px;\">\r\n");
	ViewBuilder.Append("                    <iframe id=\"frmmaindetail\" name=\"frmmaindetail\" src=\"usersearch.aspx?tab=" + echo(tab) + "&users=" + echo(users) + "\" frameborder=\"0\" scrolling=\"auto\" style=\"width: 100%;\"></iframe>\r\n");
	ViewBuilder.Append("                </div>\r\n");
	ViewBuilder.Append("            </td>\r\n");
	ViewBuilder.Append("        </tr>\r\n");
	ViewBuilder.Append("        <tr>\r\n");
