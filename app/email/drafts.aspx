<%@ Page language="c#" AutoEventWireup="false" EnableViewState="false" Inherits="FP_Email.Controller.drafts" %>
...
protected override void View()
{
	...
	ViewBuilder.Append("<title>草稿箱-内部邮件</title>\r\n");
	...
	ViewBuilder.Append("              <td><span class=\"td-nav-title\">草稿箱</span></td>\r\n");
	...
	ViewBuilder.Append("            <div class=\"btn-group\"><a id=\"batch_del\" class=\"btn\">删除草稿</a></div>\r\n");
	...
	ViewBuilder.Append("                <th style=\"width: 80px;text-align:center;\">收件人</th>\r\n");
	...
	ViewBuilder.Append("                    <i class=\"ico-draft\" title=\"草稿\"></i>\r\n");
	...
	ViewBuilder.Append("                </td>\r\n");
	ViewBuilder.Append("                <td class=\"notopen\" style=\"text-align:center;\">" + echo(item.touid_name) + "</td>\r\n");
	...
	ViewBuilder.Append("                $(win).find(\".win_title .title\").html('内部邮件 -> 草稿箱')\r\n");
	ViewBuilder.Append("            }\r\n");
	ViewBuilder.Append("        }\r\n");
	...
	ViewBuilder.Append("                window.location.href = 'create.aspx?id=' + id;\r\n");
	ViewBuilder.Append("            }\r\n");
	ViewBuilder.Append("        });\r\n");
	...
	ViewBuilder.Append("                window.confirm('删除后草稿将无法恢复，您确定要删除吗？', function (ret) {\r\n");
