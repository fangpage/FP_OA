<%@ Page language="c#" AutoEventWireup="false" EnableViewState="false" Inherits="FP_Email.Controller.sentbox" %>
...
protected override void View()
{
	...
	ViewBuilder.Append("<title>已发送-内部邮件</title>\r\n");
	...
	ViewBuilder.Append("              <td><span class=\"td-nav-title\">已发送</span></td>\r\n");
	...
	ViewBuilder.Append("            <div class=\"btn-group\"><a id=\"batch_del\" class=\"btn\">删除</a><a id=\"batch_clear\" class=\"btn\">彻底删除</a><a id=\"all_read\" data-node=\"inbox\" class=\"btn\">全部已读</a></div>\r\n");
	ViewBuilder.Append("            <div class=\"btn-group\"><a data-toggle=\"dropdown\" class=\"btn dropdown-toggle\" href=\"#\">标记为 <span class=\"caret\"></span></a>\r\n");
	...
	ViewBuilder.Append("                <th style=\"width: 100px;text-align:center;\">收件人</th>\r\n");
	...
	ViewBuilder.Append("                </td>\r\n");
	ViewBuilder.Append("                <td style=\"text-align:center;width:100px;\" class=\"ellipsis\" title=\"" + echo(item.touid_name) + "\">" + echo(item.touid_name) + "</td>\r\n");
	...
	ViewBuilder.Append("                $(win).find(\".win_title .title\").html('内部邮件 -> 已发送')\r\n");
	ViewBuilder.Append("            }\r\n");
	ViewBuilder.Append("        }\r\n");
