<%@ Page language="c#" AutoEventWireup="false" EnableViewState="false" Inherits="FP_Email.Controller.inbox" %>
...
protected override void View()
{
	...
	ViewBuilder.Append("    <title>收件箱-内部邮件</title>\r\n");
	...
	ViewBuilder.Append("                                <td><span class=\"td-nav-title\">收件箱</span></td>\r\n");
	...
	ViewBuilder.Append("                                    <a id=\"batch_del\" class=\"btn\">删除</a>\r\n");
	ViewBuilder.Append("                                    <a id=\"batch_clear\" class=\"btn\">彻底删除</a>\r\n");
	ViewBuilder.Append("                                    <a id=\"all_read\" data-node=\"inbox\" class=\"btn\">全部已读</a>\r\n");
	ViewBuilder.Append("                                </div>\r\n");
	ViewBuilder.Append("                                <div class=\"btn-group\">\r\n");
	...
	ViewBuilder.Append("                                        <li><a id=\"batch_read\" data-node=\"inbox\" tabindex=\"-1\">已读邮件</a></li>\r\n");
	ViewBuilder.Append("                                        <li><a id=\"batch_unread\" data-node=\"inbox\" tabindex=\"-1\">未读邮件</a></li>\r\n");
	ViewBuilder.Append("                                    </ul>\r\n");
	ViewBuilder.Append("                                </div>\r\n");
	...
	ViewBuilder.Append("                                    <tr>\r\n");
	ViewBuilder.Append("                                        <th style=\"width: 20px; text-align: center;\">\r\n");
	ViewBuilder.Append("                                            <input type=\"checkbox\" value=\"0\" name=\"chkall\" id=\"chkall\"></th>\r\n");
	ViewBuilder.Append("                                        <th style=\"width: 100%;\">主题</th>\r\n");
	ViewBuilder.Append("                                        <th style=\"width: 100px; text-align: center;\">发件人</th>\r\n");
	...
	ViewBuilder.Append("                                        </td>\r\n");
	ViewBuilder.Append("                                        <td style=\"text-align: center; width: 100px;\" class=\"ellipsis\" title=\"" + echo(item.fromname) + "\">" + echo(item.fromname) + "</td>\r\n");
	...
	ViewBuilder.Append("                    $(win).find(\".win_title .title\").html('内部邮件 -> 收件箱')\r\n");
	ViewBuilder.Append("                }\r\n");
	ViewBuilder.Append("            }\r\n");
	...
	ViewBuilder.Append("                }\r\n");
	ViewBuilder.Append("            });\r\n");
	ViewBuilder.Append("            //批量删除邮件事件\r\n");
	ViewBuilder.Append("            $('#batch_del').live(\"click\", function () {\r\n");
	...
	ViewBuilder.Append("                }\r\n");
	ViewBuilder.Append("            });\r\n");
	ViewBuilder.Append("            $('#email_list a.delete.td-link-icon').click(function () {\r\n");
	ViewBuilder.Append("                var cid = $(this).attr(\"data\");\r\n");
	ViewBuilder.Append("                window.confirm('确定要删除这封邮件吗?', function (ret) {\r\n");
