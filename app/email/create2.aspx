<%@ Page language="c#" AutoEventWireup="false" EnableViewState="false" Inherits="FP_Email.Controller.create2" %>
...
protected override void View()
{
	...
	ViewBuilder.Append("            </tr>\r\n");
	ViewBuilder.Append("            <tr>\r\n");
	ViewBuilder.Append("                <td style=\"text-align:right\" width=\"100\"><label class=\"control-label required\" for=\"title\">邮件主题：</label></td>\r\n");
	ViewBuilder.Append("                <td style=\"text-align:left;\"><input name=\"subject\" id=\"subject\" type=\"text\" style=\"width:450px;\" value=\"" + echo(emailinfo.subject) + "\"></td>\r\n");
	ViewBuilder.Append("            </tr>\r\n");
	ViewBuilder.Append("            <tr>\r\n");
	ViewBuilder.Append("              <td style=\"text-align:right\" valign=\"middle\"><label class=\"control-label required\">邮件内容：</label></td>\r\n");
	ViewBuilder.Append("              <td style=\"text-align:left\">\r\n");
	...
	ViewBuilder.Append("            </tr>\r\n");
	ViewBuilder.Append("            <tr>\r\n");
	ViewBuilder.Append("                <td style=\"text-align:right\" width=\"100\"><label class=\"control-label required\" for=\"title\">邮件附件：</label></td>\r\n");
	ViewBuilder.Append("                <td style=\"text-align:left;\">\r\n");
	ViewBuilder.Append("                <div>\r\n");
	...
	ViewBuilder.Append("                           <a class=\"dropdown-toggle\" href=\"" + echo(plupath) + "pdf/index.aspx?aid=" + echo(item.id) + "\"><img width=\"16\" height=\"16\" src=\"" + echo(webpath) + "common/file/" + FormatExt(item.filename).ToString() + ".gif\">" + echo(item.name) + "</a><span class=\"size\">(" + FormatSize(item.filesize).ToString() + ")</span>\r\n");
	...
	ViewBuilder.Append("    </div>\r\n");
	ViewBuilder.Append("  </div>\r\n");
	ViewBuilder.Append("  <div id=\"attachmentRename\" class=\"modal hide fade\">\r\n");
	ViewBuilder.Append("    <div class=\"modal-header\">\r\n");
	ViewBuilder.Append("    <h4 style=\"height:20px;width:30%;display: inline-block;\">重命名</h4>\r\n");
	ViewBuilder.Append("    <div style=\"display: none; margin: 0px; padding-top: 2px; padding-bottom: 2px;\" class=\"alert in  fade alert-error\"></div>\r\n");
	ViewBuilder.Append("    </div>\r\n");
	ViewBuilder.Append("    <div class=\"modal-body\" style=\"height: 60px;padding-top: 10px;padding-bottom: 0;\">\r\n");
	ViewBuilder.Append("    <input class=\"file_id\" name=\"file_id\" type=\"hidden\">\r\n");
	ViewBuilder.Append("    <input class=\"rename_url\" name=\"rename_url\" type=\"hidden\">\r\n");
	ViewBuilder.Append("    <label class=\"control-label require\" name=\"file_id\" style=\"display:inline-block;margin-right:10px;\">附件名称 <span class=\"required\">*</span></label>\r\n");
	ViewBuilder.Append("    <div class=\"input-append\">\r\n");
	ViewBuilder.Append("        <input class=\"file_name\" name=\"file_name\" type=\"text\" style=\"width:300px;\">\r\n");
	ViewBuilder.Append("        <span class=\"add-on\"></span></div>\r\n");
	ViewBuilder.Append("    </div>\r\n");
	ViewBuilder.Append("    <div class=\"modal-footer\"><a class=\"btn btn-danger submit\">确定</a><a data-dismiss=\"modal\" class=\"btn\">关闭</a></div>\r\n");
	ViewBuilder.Append("</div>\r\n");
	ViewBuilder.Append("</div>\r\n");
	int status = 0;
	...
	ViewBuilder.Append("            \"formData\":{ 'attachid': '" + echo(emailinfo.attachid) + "','status':'" + echo(status) + "','app':'" + echo(setupinfo.markup) + "','postid':'" + echo(emailinfo.id) + "'},\r\n");
