<%@ Page language="c#" AutoEventWireup="false" EnableViewState="false" Inherits="FP_Document.Controller.documentmanage" %>
...
protected override void View()
{
	...
	ViewBuilder.Append("<title>收发文管理</title>\r\n");
	...
	ViewBuilder.Append("            if(confirm(\"你确定要彻底删除吗？删除后无法进行恢复！！\")){\r\n");
	ViewBuilder.Append("                $(\"#action\").val(\"com_delete\");\r\n");
	ViewBuilder.Append("                $(\"#frmpost\").submit()\r\n");
	ViewBuilder.Append("            }\r\n");
	ViewBuilder.Append("        })\r\n");
	ViewBuilder.Append("        //移动\r\n");
	...
	ViewBuilder.Append("        $(\"#btn_del\").click(function(){\r\n");
	...
	{
	ViewBuilder.Append("        PageNav(\"发文管理," + echo(rawpath) + "documentmanage.aspx\");\r\n");
	}//end if
	ViewBuilder.Append("    })\r\n");
	...
	ViewBuilder.Append("              <li style=\"background: url(" + echo(adminpath) + "statics/images/return.gif) 2px 6px no-repeat\"><a id=\"btn_del\" href=\"#\">删除恢复</a></li>                   \r\n");
	...
	ViewBuilder.Append("        	  <td>公文标题</td>\r\n");
	ViewBuilder.Append("              <td>公文文号</td>\r\n");
	ViewBuilder.Append("              <td width=\"120\">公文类型</td>\r\n");
	ViewBuilder.Append("              <td width=\"80\">发起人</td>\r\n");
	ViewBuilder.Append("              <td width=\"150\">发布时间</td>\r\n");
	...
	ViewBuilder.Append("              <td align=\"left\"><a class=\"subject\" href=\"docshow.aspx?id=" + echo(item.id) + "\">" + echo(item.title) + "</a></td>\r\n");
	ViewBuilder.Append("              <td align=\"center\">" + echo(item.number) + "</td>\r\n");
	ViewBuilder.Append("              <td align=\"center\">" + echo(item.sortname) + "</td>\r\n");
	ViewBuilder.Append("              <td align=\"center\">" + echo(item.fromuname) + "</td>\r\n");
	...
	if (item.status==1)
	{
	ViewBuilder.Append("                <span style=\"color:#ff0000\">执行中</span>\r\n");
	}
	else if (item.status==2)
	{
	ViewBuilder.Append("                <span style=\"color:#0026ff\">已办结</span>\r\n");
	}
	else if (item.status==3)
	{
	ViewBuilder.Append("                <span style=\"color:#808080\">已完成</span>\r\n");
	}//end if
	}//end if
	ViewBuilder.Append("              </td>\r\n");
	ViewBuilder.Append("              <td><a class=\"subject\" href=\"docshow.aspx?id=" + echo(item.id) + "\">查看</a></td>\r\n");
	ViewBuilder.Append("            </tr>\r\n");
	}//end loop
	ViewBuilder.Append("          </tbody>\r\n");
	...
	ViewBuilder.Append("        <tbody>\r\n");
	ViewBuilder.Append("            <tr>\r\n");
	ViewBuilder.Append("            <td style=\"width:80px;text-align:right;\"> 公文标题： </td>\r\n");
	ViewBuilder.Append("            <td align=\"left\"><input name=\"title\" type=\"text\" value=\"" + echo(title) + "\" id=\"title\" style=\"height:21px;width:250px;\"></td>\r\n");
	ViewBuilder.Append("            </tr>\r\n");
	ViewBuilder.Append("            <tr>\r\n");
