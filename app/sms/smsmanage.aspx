<%@ Page language="c#" AutoEventWireup="false" EnableViewState="false" Inherits="FP_SMS.Controller.smsmanage" %>
...
protected override void View()
{
	...
	ViewBuilder.Append("<title>手机短信发送记录</title>\r\n");
	...
	ViewBuilder.Append("              <td><span class=\"td-nav-title\">短信发送记录</span></td>\r\n");
	ViewBuilder.Append("            </tr>\r\n");
	ViewBuilder.Append("          </tbody>\r\n");
	...
	ViewBuilder.Append("            <div class=\"btn-group\"><a class=\"btn\" id=\"btn_delete\" href=\"#\">删除短信</a></div>\r\n");
	...
	ViewBuilder.Append("                <th>接收人</th>\r\n");
	ViewBuilder.Append("                <th>发送内容</th>\r\n");
	ViewBuilder.Append("                <th style=\"width:160px;text-align:center;\">发送时间</th>\r\n");
	ViewBuilder.Append("                <th style=\"width:80px;text-align:center;\">发送状态</th>\r\n");
	ViewBuilder.Append("                <th style=\"width: 120px;text-align:center;\">操作</th>\r\n");
	ViewBuilder.Append("              </tr>\r\n");
	ViewBuilder.Append("            </thead>\r\n");
	ViewBuilder.Append("            <tbody>\r\n");

	loop__id=0;
	foreach(SMSInfo item in smslist)
	{
	loop__id++;
	...
	ViewBuilder.Append("                <td class=\"ellipsis\"><a title=\"" + echo(item.sendto) + "\" rel=\"tooltip\" href=\"#\" data-original-title=\"" + echo(item.sendto) + "\">" + echo(item.sendto) + "</a></td>\r\n");
	...
	if (item.status==1)
	{
	ViewBuilder.Append("                  <span class=\"label label-info\"><b>发送成功</b></span>\r\n");
	}
	else
	{
	ViewBuilder.Append("                  <span class=\"label label-important\"><b>发送失败</b></span>\r\n");
	}//end if
	ViewBuilder.Append("                </td>\r\n");
	ViewBuilder.Append("                <td style=\"text-align:center;\">\r\n");
	ViewBuilder.Append("                    <a class=\"update td-link-icon\" href=\"smssend.aspx?id=" + echo(item.id) + "\"><i class=\"icon-pencil\"></i>转发</a>\r\n");
	...
	ViewBuilder.Append("                $(win).find(\".win_title .title\").html('手机短信 -> 发送记录')\r\n");
	ViewBuilder.Append("            }\r\n");
	ViewBuilder.Append("        }\r\n");
	...
	ViewBuilder.Append("              window.confirm('确定要批量删除所选的短信吗？删除后将无法进恢复。', function (ret) {\r\n");
	...
	ViewBuilder.Append("      $('#gridview a.delete.td-link-icon').click(function () {\r\n");
