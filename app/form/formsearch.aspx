<%@ Page language="c#" AutoEventWireup="false" EnableViewState="false" Inherits="FP_Form.Controller.formsearch" %>
...
protected override void View()
{
	...
	ViewBuilder.Append("<title>查询选择表单</title>\r\n");
	...
	ViewBuilder.Append("        	  <td colspan=\"2\">表单名称</td>\r\n");
	ViewBuilder.Append("            </tr>\r\n");
	...
	ViewBuilder.Append("               <td width=\"30\">\r\n");
	ViewBuilder.Append("                   <input id=\"chkid\" name=\"chkid\" value=\"" + echo(item.id) + "\" type=\"radio\">\r\n");
	ViewBuilder.Append("               </td>\r\n");
