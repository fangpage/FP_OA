<%@ Page language="c#" AutoEventWireup="false" EnableViewState="false" Inherits="FP_WorkFlow.Controller.taskjbadd" %>
...
protected override void View()
{
	...
	ViewBuilder.Append("                                        <input name=\"title\" id=\"title\" type=\"text\" style=\"width: 400px;\" maxlength=\"255\" value=\"" + echo(taskjbinfo.title) + "\"></td>\r\n");
	ViewBuilder.Append("                                </tr>\r\n");
	...
	ViewBuilder.Append("                                    <td style=\"text-align: left;\">\r\n");
	ViewBuilder.Append("                                        <div>\r\n");
	ViewBuilder.Append("                                            <input id=\"attachid\" name=\"attachid\" value=\"" + echo(taskjbinfo.attachid) + "\" type=\"hidden\">\r\n");
	...
	loop__id=0;
	foreach(AttachInfo item in AttachBll.GetAttachList(taskjbinfo.attachid))
	{
	loop__id++;
	...
	ViewBuilder.Append("                                                <input type=\"hidden\" id=\"PRCS_OP_USER2\" data_type=\"op_user_btn\" name=\"PRCS_OP_USER2\" value=\"" + echo(taskjbinfo.turnuid) + "\">\r\n");
	ViewBuilder.Append("                                                <div class=\"sponsor\" style=\"float: left;\">\r\n");
	ViewBuilder.Append("                                                    <a class=\"prcs-op-uname\" id=\"TOP_FLAG_SHOW2\">主办人：</a>\r\n");
	ViewBuilder.Append("                                                </div>\r\n");

	loop__id=0;
	foreach(UserInfo item in GetUserList(taskjbinfo.turnuid))
	{
	loop__id++;
	...
	if (taskjbinfo.touid!="")
	{
	ViewBuilder.Append("                                                <input type=\"hidden\" data_type=\"op_user_btn\" id=\"PRCS_USER2\" name=\"PRCS_USER2\" value=\"" + echo(taskjbinfo.touid) + "\">\r\n");
	}
	else
	{
	...
	loop__id=0;
	foreach(UserInfo item in GetUserList(taskjbinfo.touid))
	{
	loop__id++;
	ViewBuilder.Append("                                                <div class=\"user-tags\" user_id=\"" + echo(item.id) + "\">" + echo(item.realname) + "<i class=\"close\">×</i></div>\r\n");
	}//end loop
	...
	ViewBuilder.Append("                                    <td style=\"text-align: left\">\r\n");
	ViewBuilder.Append("                                        <textarea id=\"content\" name=\"content\" style=\"width: 800px; height: 300px\" cols=\"20\" rows=\"2\">" + echo(taskjbinfo.content) + "</textarea>\r\n");
	ViewBuilder.Append("                                    </td>\r\n");
	ViewBuilder.Append("                                </tr>\r\n");
	ViewBuilder.Append("                            </tbody>\r\n");
	ViewBuilder.Append("                        </table>\r\n");
	...
	ViewBuilder.Append("                \"formData\": { 'attachid': '" + echo(taskjbinfo.attachid) + "', 'status': '" + echo(status) + "', 'app': '" + echo(setupinfo.markup) + "', 'postid': '" + echo(taskjbinfo.id) + "' },\r\n");
	...
	ViewBuilder.Append("            }\r\n");
	ViewBuilder.Append("            else {\r\n");
	ViewBuilder.Append("                window.location.href = \"" + echo(pagename) + "?id=" + echo(taskjbinfo.id) + "\";\r\n");
	ViewBuilder.Append("            }\r\n");
	ViewBuilder.Append("        }\r\n");
	ViewBuilder.Append("    </");
	ViewBuilder.Append("script>\r\n");
