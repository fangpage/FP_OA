...
protected override void View()
{
	...
	ViewBuilder.Append("    <title>待办工作</title>\r\n");
	...
	ViewBuilder.Append("                                <td><span class=\"td-nav-title\">待办理工作</span></td>\r\n");
	...
	{
	ViewBuilder.Append("                                            <a class=\"subject\" target=\"_blank\" href=\"taskview.aspx?id=" + echo(item.id) + "\" title=\"" + echo(item.title) + "\">\r\n");
	ViewBuilder.Append("                                                <img src=\"statics/images/" + echo(ostr) + "\" style=\"vertical-align: text-bottom; margin-right: 3px;\"><img src=\"statics/images/" + echo(fav) + "\" style=\"vertical-align: text-bottom; margin-right: 3px;\">" + echo(item.title) + "</a>\r\n");
	}
	else if (item.type==1&&item.uid==userid)
	{
	ViewBuilder.Append("                                            <a class=\"subject\" target=\"_blank\" href=\"taskadd.aspx?id=" + echo(item.id) + "\" title=\"" + echo(item.title) + "\">\r\n");
	ViewBuilder.Append("                                                <img src=\"statics/images/" + echo(ostr) + "\" style=\"vertical-align: text-bottom; margin-right: 3px;\"><img src=\"statics/images/" + echo(fav) + "\" style=\"vertical-align: text-bottom; margin-right: 3px;\">" + echo(item.title) + "</a>\r\n");
	}
	else
	{
	ViewBuilder.Append("                                            <a class=\"subject\" target=\"_blank\" href=\"workflow.aspx?id=" + echo(item.id) + "\" title=\"" + echo(item.title) + "\">\r\n");
	ViewBuilder.Append("                                                <img src=\"statics/images/" + echo(ostr) + "\" style=\"vertical-align: text-bottom; margin-right: 3px;\"><img src=\"statics/images/" + echo(fav) + "\" style=\"vertical-align: text-bottom; margin-right: 3px;\">" + echo(item.title) + "</a>\r\n");
	}//end if
	ViewBuilder.Append("                                        </td>\r\n");
	...
	{
	ViewBuilder.Append("                                            <a class=\"subject\" target=\"_blank\" href=\"taskview.aspx?id=" + echo(item.id) + "\">" + echo(astr) + "第" + echo(item.step) + "步：主办</a>\r\n");
	}
	else if (item.type==1&&item.uid==0&&item.isadmin==0)
	{
	ViewBuilder.Append("                                            <a class=\"subject\" target=\"_blank\" href=\"taskview.aspx?id=" + echo(item.id) + "\">" + echo(astr) + "第" + echo(item.step) + "步：会签</a>\r\n");
	}
	else if (item.type==1&&item.uid==userid)
	{
	ViewBuilder.Append("                                            <a class=\"subject\" target=\"_blank\" href=\"taskadd.aspx?id=" + echo(item.id) + "\">" + echo(astr) + "第" + echo(item.step) + "步：发起</a>\r\n");
	}
	else if (item.type==2&&item.uid==userid)
	{
	ViewBuilder.Append("                                            <a class=\"subject\" target=\"_blank\" href=\"taskjbview.aspx?id=" + echo(item.id) + "\">" + echo(astr) + "第" + echo(item.step) + "步：主办</a>\r\n");
	}
	else
	{
	ViewBuilder.Append("                                            <a class=\"subject\" target=\"_blank\" href=\"workflow.aspx?id=" + echo(item.id) + "&&action=flowlist\" title=\"" + echo(astr) + "第" + echo(item.step) + "步：" + echo(item.stepname) + "\">" + echo(astr) + "第" + echo(item.step) + "步：" + echo(item.stepname) + "</a>\r\n");
	}//end if
	ViewBuilder.Append("                                        </td>\r\n");
