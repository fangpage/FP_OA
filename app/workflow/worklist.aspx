...
protected override void View()
{
	...
	ViewBuilder.Append("    <title>已办理工作</title>\r\n");
	...
	ViewBuilder.Append("                                <td><span class=\"td-nav-title\">已办理工作</span></td>\r\n");
	...
	if (item.type==1)
	{
	ViewBuilder.Append("                                            <a class=\"subject\" href=\"taskview.aspx?id=" + echo(item.id) + "\" title=\"" + echo(item.title) + "\"><i class=\"ico-send\"></i>\r\n");
	ViewBuilder.Append("                                                <img src=\"statics/images/" + echo(fav) + "\" style=\"vertical-align: text-bottom; margin-right: 3px;\">" + echo(item.title) + "</a>\r\n");
	}
	else if (item.type==2)
	{
	ViewBuilder.Append("                                            <a class=\"subject\" href=\"taskjbview.aspx?id=" + echo(item.id) + "\" title=\"" + echo(item.title) + "\"><i class=\"ico-send\"></i>\r\n");
	ViewBuilder.Append("                                                <img src=\"statics/images/" + echo(fav) + "\" style=\"vertical-align: text-bottom; margin-right: 3px;\">" + echo(item.title) + "</a>\r\n");
	}
	else
	{
	ViewBuilder.Append("                                            <a class=\"subject\" href=\"workview.aspx?id=" + echo(item.id) + "\" title=\"" + echo(item.title) + "\"><i class=\"ico-send\"></i>\r\n");
	ViewBuilder.Append("                                                <img src=\"statics/images/" + echo(fav) + "\" style=\"vertical-align: text-bottom; margin-right: 3px;\">" + echo(item.title) + "</a>\r\n");
	}//end if
	ViewBuilder.Append("                                        </td>\r\n");
