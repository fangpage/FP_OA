...
protected override void View()
{
	...
	ViewBuilder.Append("            </div>\r\n");
	ViewBuilder.Append("            <div style=\"margin-left:10px;\">\r\n");
	...
	ViewBuilder.Append("                  <dl class=\"T_linecolor  comment_box clearfix\" style=\"margin:5px 0\">\r\n");
	...
	ViewBuilder.Append("                              <div class=\"comment_header_author\" title=\"部门：" + echo(item.departname) + "\"><span style=\"color:#ff0000\">" + echo(item.realname) + "</span>/" + echo(item.title) + "</div>\r\n");
	ViewBuilder.Append("                              <div class=\"comment_header_date\" style=\"float:right;\">" + echo(item.postdatetime,"yyyy-MM-dd HH:mm") + "</div>\r\n");
	ViewBuilder.Append("                            </div>\r\n");
	ViewBuilder.Append("                             <div class=\"comment_content\">" + echo(item.content) + "</div>\r\n");
	ViewBuilder.Append("                          </div>\r\n");
	ViewBuilder.Append("                        </div>\r\n");
	...
	ViewBuilder.Append("                      <form style=\"margin:0px 0px 10px 0px;\" id=\"frmcomment\" name=\"frmcomment\" action=\"\" method=\"post\" enctype=\"multipart/form-data\">\r\n");
	ViewBuilder.Append("                        <input type=\"hidden\" id=\"action_comment\" name=\"action\" value=\"comment\">\r\n");
	ViewBuilder.Append("                        <input id=\"id_comment\" name=\"id\" value=\"" + echo(id) + "\" type=\"hidden\">\r\n");
	ViewBuilder.Append("                        <input type=\"hidden\" id=\"comment_attachid\" name=\"attachid\" value=\"" + echo(commentinfo.attachid) + "\">\r\n");
	...
	ViewBuilder.Append("                        <textarea id=\"comment\" name=\"comment\" style=\"width:686px;height:80px\">" + echo(commentinfo.content) + "</textarea>\r\n");
	ViewBuilder.Append("                      </form>\r\n");
	ViewBuilder.Append("                      <button id=\"btn_quick\" class=\"btn btn-primary\" name=\"btn_quick\" type=\"button\">快捷输入</button>\r\n");
	ViewBuilder.Append("                      <button id=\"submitComment\" class=\"btn btn-danger\" name=\"submitComment\" type=\"button\">保存我的意见</button>\r\n");

	if (workflowinfo.isadmin==0&&workflowinfo.status<=1)
	{
	ViewBuilder.Append("                      <div style=\"float:right;\"><a style=\"margin-right:3px;\" class=\"btn btn-warning\" id=\"btn_end\">办理完毕</a></div>\r\n");
	}//end if
	ViewBuilder.Append("                    </div>\r\n");
	ViewBuilder.Append("                    <div class=\"arrow\"><span>◆</span></div>\r\n");
	ViewBuilder.Append("                  </div>\r\n");
