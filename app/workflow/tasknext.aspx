...
protected override void View()
{
	...
	ViewBuilder.Append("<title>提交办理情况-" + echo(taskinfo.title) + "</title>\r\n");
	...
	ViewBuilder.Append("            parent.update(1);\r\n");
	...
	ViewBuilder.Append("              <td><span class=\"td-nav-title\">" + echo(taskinfo.title) + "-办理情况提交</span></td>\r\n");
	ViewBuilder.Append("              <td><div class=\"pull-right\">\r\n");
	ViewBuilder.Append("                  <a style=\"margin-right:3px;\" class=\"btn btn-danger\" id=\"btn_turn\">确定</a>\r\n");
	...
	if (taskinfo.isadmin==1)
	{
	ViewBuilder.Append("            <tr>\r\n");
	ViewBuilder.Append("              <td style=\"text-align:right\" width=\"150\"><br>转交下一步办理人：</td>\r\n");
	...
	ViewBuilder.Append("                  <span style=\"margin:0 4px;\">（如果当前工作已办结，可以不用选择下一步办理人）</span>\r\n");
	ViewBuilder.Append("              </td>\r\n");
	ViewBuilder.Append("            </tr>\r\n");
	}//end if
	ViewBuilder.Append("            <tr>\r\n");
	ViewBuilder.Append("              <td style=\"text-align:right\" width=\"150\">上传办理附件：</td>\r\n");
	ViewBuilder.Append("              <td style=\"text-align:left;\">\r\n");
	ViewBuilder.Append("                 <div>\r\n");
	...
	ViewBuilder.Append("            </tr>\r\n");
	ViewBuilder.Append("            <tr>\r\n");
	ViewBuilder.Append("              <td style=\"text-align:right\" valign=\"middle\">我的办理情况：</td>\r\n");
	ViewBuilder.Append("              <td style=\"text-align:left\">\r\n");
