...
protected override void View()
{
	...
	ViewBuilder.Append("            <span class=\"td-nav-title\" style=\"display: block;\" title=\"工作标题：" + echo(workinfo.title) + "\"><span style=\"font-weight:bold;\">工作标题：</span>" + echo(CutString(workinfo.title,30)) + "\r\n");
	...
	if (workinfo.allowback==1&&workinfo.status==2&&workinfo.isadmin==1)
	{
	ViewBuilder.Append("                  <a style=\"margin-right:3px;\" class=\"btn btn-danger\" id=\"btn_back\">撤回工作</a>\r\n");
	}//end if
