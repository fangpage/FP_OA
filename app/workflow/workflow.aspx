...
protected override void View()
{
	...
	if (istitle)
	{
	ViewBuilder.Append("                            <span class=\"td-nav-title\" style=\"display: block;\" title=\"工作标题：" + echo(workinfo.title) + "\"><span style=\"font-weight: bold;\">工作标题：</span><span id=\"showtitle\">" + echo(CutString(workinfo.title,30)) + "</span>&nbsp;<a class=\"label label-important\" id=\"btn_title\" href=\"#\"><i class=\"icon-pencil-5\"></i>编辑</a></span>\r\n");
	ViewBuilder.Append("                            <form style=\"margin: 0px;\" class=\"form-inline\" id=\"titleform\" action=\"\" method=\"post\">\r\n");
	ViewBuilder.Append("                                <input style=\"width: 100%; display: none;\" placeholder=\"工作标题\" name=\"title\" id=\"title\" type=\"text\" maxlength=\"255\" value=\"" + echo(workinfo.title) + "\">\r\n");
	ViewBuilder.Append("                            </form>\r\n");
	}
	else
	{
	ViewBuilder.Append("                            <span class=\"td-nav-title\" style=\"display: block;\">工作标题：" + echo(workinfo.title) + "</span>\r\n");
	}//end if
	ViewBuilder.Append("                        </td>\r\n");
	ViewBuilder.Append("                        <td>\r\n");
	...
	if (workinfo.isfav==1)
	{
	ViewBuilder.Append("                                <a style=\"margin-right: 3px;\" class=\"btn btn-success disabled\" id=\"btn_fav\">取消关注</a>\r\n");
	}
	else
	{
	ViewBuilder.Append("                                <a style=\"margin-right: 3px;\" class=\"btn btn-info\" id=\"btn_fav\">关注工作</a>\r\n");
	}//end if
	...
	ViewBuilder.Append("                    {\r\n");
	ViewBuilder.Append("                        othis.html(\"关注工作\");\r\n");
	ViewBuilder.Append("                    }\r\n");
	ViewBuilder.Append("                    else{\r\n");
